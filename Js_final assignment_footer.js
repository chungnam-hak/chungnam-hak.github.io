...
function F_HTML_Textdesign(){
    ...
    <img id = "f_img" onclick = "OnImgView()" src="img/textdesign.png" alt="3주차_p.14" title = "3주차_p.14" style="position: relative; bottom: 50px; right: 50px; height: 180px; margin: 0; padding: 0; float:right">
        <p style="padding: 5px;">
            ...
            <span style="color:blue">태그의 종류는 오른쪽 이미지를 클릭해 확인하자!</span>
        </p>`
    Footer_Blend(); //집중 효과!
}
...
function F_HTML_SC(){
    ...
    f.innerHTML = `
    <h3>특수문자, 기호, 심볼 삽입</h3>
    <img id = "f_img" onclick = "OnImgView2()" src="img/SC.png" alt="3주차_p.11" title = "3주차_p.11" style="position: relative; bottom: 50px; right: 50px; height: 180px; margin: 0; padding: 0; float:right">
        <p style="padding: 5px;">
