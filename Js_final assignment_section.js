...
function S_HTML_Base(){
    ...
    <h3 style="padding: 5px;">HTML의 기본틀</h3>
        <ul style = "list-style-type : none;">
            <li><strong>&lt!DOCTYPE html&gt</strong></li> &emsp;- 문서 형식 선언; 해당문서가 HTML5 문서임을 알리는 선언 <br><br>
            <li id = "li_Sel" onclick="F_HTML_Annotation()"><strong>&lt!-- 주석넣기--&gt</strong></li> &emsp;- 주석; 개발자의 이해와 공유를 위한 메모로, 화면에 출력되지 않는다.<br><br>
            <li><strong>&lthtml&gt</strong></li> &emsp;//html 태그; 페이지 구조의 시작과 끝을 알리는 태그<br><br>
...
function S_HTML_SematicTag(){ 
    ...
    <ul style = "list-style-type : circle; position: relative; left:70px; ">
        ...
        <li><span id = "upsel" onclick ="OnImgView('img/SematicTag3.png','600px')" style="color:blue; padding : 0px;"><strong>* CSS를 더한 시맨틱 태그 예시</strong></span></li>
    </ul>`
}
//2-5. HTML_List_Table
function S_HTML_List_Table(){
    ...
    <ul style = "list-style-type : circle;">
        ...
        &emsp; <span id = "upsel" onclick ="OnImgView('img/LT_ol.png','600px')" style="color:blue; padding : 0px;"><strong>* 순서 있는 리스트 예시</strong></span> </li><br>
        <li><strong>순서 없는 리스트(unordered list) - &lt;ul&gt;. . . &lt;/ul&gt;</strong> <br> 
        &emsp; <span id = "upsel" onclick ="OnImgView('img/LT_ul.png','600px')" style="color:blue; padding : 0px;"><strong>* 순서 없는 리스트 예시</strong></span> </li><br>
        ...
        &emsp; <span id = "upsel" onclick ="OnImgView('img/LT_dl.png','600px')" style="color:blue; padding : 0px;"><strong>* 정의 리스트 예시</strong></span><br> </li>

        <li><strong>표(table) </strong> <br>
        <ul style = "list-style-type : square;">
            ...
            <li>&lt;td&gt; : &nbsp;데이터 셀</li>
            <span id = "upsel" onclick ="OnImgView('img/LT_table.png','600px')" style="color:blue; padding : 0px; position:relative; right:20px;"><strong>* 표 예시</strong></span>
        </ul></li> 
    ...
    <ul style = "list-style-type : circle; ">
        ...
        <li><strong>폼 요소</strong>
            <p>
                ...
                폼 요소 : &nbsp; &lt;input&gt;,&nbsp;
                        <span id = "s_sel" onclick ="OnImgView('img/WebForm_textarea.png','500px')" style="color:blue;">&lt;textarea&gt;</span>,&nbsp; 
                        <span id = "s_sel" onclick ="OnImgView('img/WebForm_select.png','600px')" style="color:blue;">&lt;select&gt;</span>,&nbsp;
                        <span id = "s_sel" onclick ="OnImgView('img/WebForm_datalist.png','600px')" style="color:blue;">&lt;datalist&gt;</span> 등. 
                        <span class="ssmall-br"></span><br>
                <span id = "s_sel" onclick ="OnImgView('img/WebForm_type.png','600px')" style="color:blue;"><strong>* 폼 요소의 종류</strong></span>
    ...
    &emsp;<strong>이미지, 하이퍼링크, 외부 CSS, JS 파일을 받아 올수 있다.</strong>
        <ul style = "list-style-type : circle;">
            <li><strong>이미지 삽입 </strong>
                - <span id = "s_sel" onclick ="OnImgView('img/Ex_img.png','600px')" style="color:blue;"><strong>&lt;img &gt;</strong></span><br>
                현 html 파일의 위치를 기준으로 이미지 파일에 접근해서 참조하는 태그이다.<br>
                태그의 속성으로 이미지의 이름, 너비와 높이 등을 설정할수 있다.
            </li><br>
            <li><strong>하이퍼링크</strong>
                 - <span id = "s_sel" onclick ="OnImgView('img/Ex_a.png','600px')" style="color:blue;"><strong>&lt;a href = ""&gt;</strong></span><br>
                다른 웹페이지의 주소를 href에 담아서 현 html에서 접근할수 있도록 하는 태그이다.<br>
                태그의 속성으로 이미지의 이름, 너비와 높이 등을 설정할 수 있다.

            </li><br>
            <li><strong>CSS파일 참조</strong> 
                - <span id = "s_sel" onclick ="OnImgView('img/Ex_link_css.png','500px')" style="color:blue;"><strong>&lt;link &gt;</strong></span><br>
                ...
                <img src="img/Ex_link.png" alt="5주차_p.5" title = "5주차_p.5" style=" margin: 0; padding: 0;"><br>

                
            </li><br>
            <li><strong>JAVASCRIPT파일 참조</strong> 
                - <span id = "s_sel" onclick ="OnImgView('img/Ex_script.png','550px')" style="color:blue;"><strong>&lt;script &gt;</strong></span><br>
